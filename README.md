...
Operador de telecomunicaciones Megaline. La empresa ofrece a sus clientes dos tarifas de prepago, Surf y Ultimate. El departamento comercial quiere saber cuál de los planes genera más ingresos para poder ajustar el presupuesto de publicidad.
...
<h3> Resumen de Redondeo de Tarifas Megaline </h3>

Llamadas: Cada llamada individual se redondea al minuto completo (incluso un solo segundo se cobra como un minuto).

Tráfico Web: El total mensual de datos se redondea al gigabyte completo (por ejemplo, 1025 MB se cobran como 2 GB).
